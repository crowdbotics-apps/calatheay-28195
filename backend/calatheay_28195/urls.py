"""calatheay_28195 URL Configuration
...
admin.site.site_header = "Calatheay"
admin.site.site_title = "Calatheay Admin Portal"
admin.site.index_title = "Calatheay Admin"

# swagger
api_info = openapi.Info(
    title="Calatheay API",
    default_version="v1",
    description="API documentation for Calatheay App",
)
